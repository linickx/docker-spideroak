...
libc-bin            2.41-12+deb13u3              (won't fix)  deb     CVE-2026-5450        Critical    0.5% (40th)   0.5    
libc6               2.41-12+deb13u3              (won't fix)  deb     CVE-2026-5450        Critical    0.5% (40th)   0.5    
perl-base           5.40.1-6                     (won't fix)  deb     CVE-2026-8376        Critical    0.4% (36th)   0.4    
perl-base           5.40.1-6                                  deb     CVE-2026-13221       Critical    0.4% (35th)   0.4    
perl-base           5.40.1-6                     (won't fix)  deb     CVE-2026-42496       Critical    0.4% (35th)   0.4    
...
perl-base           5.40.1-6                                  deb     CVE-2026-57433       Critical    0.4% (28th)   0.3    
perl-base           5.40.1-6                     (won't fix)  deb     CVE-2026-42497       High        0.4% (34th)   0.3    
...
libc-bin            2.41-12+deb13u3              (won't fix)  deb     CVE-2026-5928        High        0.4% (29th)   0.3    
libc6               2.41-12+deb13u3              (won't fix)  deb     CVE-2026-5928        High        0.4% (29th)   0.3    
...
libc-bin            2.41-12+deb13u3              (won't fix)  deb     CVE-2026-6238        Medium      0.4% (28th)   0.2    
libc6               2.41-12+deb13u3              (won't fix)  deb     CVE-2026-6238        Medium      0.4% (28th)   0.2    
...
libc-bin            2.41-12+deb13u3                           deb     CVE-2019-1010024     Negligible  3.2% (86th)   0.2    
libc6               2.41-12+deb13u3                           deb     CVE-2019-1010024     Negligible  3.2% (86th)   0.2    
...
login.defs          1:4.17.4-2                   (won't fix)  deb     CVE-2024-56433       Low         0.4% (33rd)   0.1    
passwd              1:4.17.4-2                   (won't fix)  deb     CVE-2024-56433       Low         0.4% (33rd)   0.1    
...
libsqlite3-0        3.46.1-7+deb13u1                          deb     CVE-2021-45346       Negligible  1.6% (73rd)   < 0.1  
...
bsdutils            1:2.41-5                     (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
libblkid1           2.41-5                       (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
liblastlog2-2       2.41-5                       (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
libmount1           2.41-5                       (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
libsmartcols1       2.41-5                       (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
libuuid1            2.41-5                       (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
login               1:4.16.0-2+really2.41-5      (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
mount               2.41-5                       (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
util-linux          2.41-5                       (won't fix)  deb     CVE-2026-27456       Medium      0.1% (1st)    < 0.1  
gzip                1.13-1                       (won't fix)  deb     CVE-2026-41991       Medium      0.1% (1st)    < 0.1  
bsdutils            1:2.41-5                                  deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
libblkid1           2.41-5                                    deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
liblastlog2-2       2.41-5                                    deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
libmount1           2.41-5                                    deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
libsmartcols1       2.41-5                                    deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
libuuid1            2.41-5                                    deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
login               1:4.16.0-2+really2.41-5                   deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
mount               2.41-5                                    deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
util-linux          2.41-5                                    deb     CVE-2026-13595       Medium      0.1% (1st)    < 0.1  
pyopenssl           18.0.0                       26.0.0       python  GHSA-vp96-hxj8-p424  Low         0.2% (15th)   < 0.1  
libsystemd0         257.13-1~deb13u1             (won't fix)  deb     CVE-2026-40228       Low         0.2% (6th)    < 0.1  
libudev1            257.13-1~deb13u1             (won't fix)  deb     CVE-2026-40228       Low         0.2% (6th)    < 0.1  
...
login.defs          1:4.17.4-2                                deb     CVE-2007-5686        Negligible  0.9% (57th)   < 0.1  
passwd              1:4.17.4-2                                deb     CVE-2007-5686        Negligible  0.9% (57th)   < 0.1  
...
perl-base           5.40.1-6                                  deb     CVE-2011-4116        Negligible  0.5% (41st)   < 0.1  
...
libsystemd0         257.13-1~deb13u1                          deb     CVE-2023-31439       Negligible  0.3% (27th)   < 0.1  
libudev1            257.13-1~deb13u1                          deb     CVE-2023-31439       Negligible  0.3% (27th)   < 0.1  
coreutils           9.7-3                                     deb     CVE-2017-18018       Negligible  0.3% (27th)   < 0.1  
...
diffutils           1:3.10-4                                  deb     CVE-2026-53910       Negligible  0.3% (16th)   < 0.1  
coreutils           9.7-3                                     deb     CVE-2025-5278        Negligible  0.2% (14th)   < 0.1  
...
bsdutils            1:2.41-5                                  deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
libblkid1           2.41-5                                    deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
liblastlog2-2       2.41-5                                    deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
libmount1           2.41-5                                    deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
libsmartcols1       2.41-5                                    deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
libuuid1            2.41-5                                    deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
login               1:4.16.0-2+really2.41-5                   deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
mount               2.41-5                                    deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
util-linux          2.41-5                                    deb     CVE-2025-14104       Negligible  0.2% (9th)    < 0.1  
...
bsdutils            1:2.41-5                                  deb     CVE-2026-53612       Unknown     N/A           N/A    
bsdutils            1:2.41-5                                  deb     CVE-2026-53613       Unknown     N/A           N/A    
bsdutils            1:2.41-5                                  deb     CVE-2026-53614       Unknown     N/A           N/A    
bsdutils            1:2.41-5                                  deb     CVE-2026-53615       Unknown     N/A           N/A    
libblkid1           2.41-5                                    deb     CVE-2026-53612       Unknown     N/A           N/A    
libblkid1           2.41-5                                    deb     CVE-2026-53613       Unknown     N/A           N/A    
libblkid1           2.41-5                                    deb     CVE-2026-53614       Unknown     N/A           N/A    
libblkid1           2.41-5                                    deb     CVE-2026-53615       Unknown     N/A           N/A    
liblastlog2-2       2.41-5                                    deb     CVE-2026-53612       Unknown     N/A           N/A    
liblastlog2-2       2.41-5                                    deb     CVE-2026-53613       Unknown     N/A           N/A    
liblastlog2-2       2.41-5                                    deb     CVE-2026-53614       Unknown     N/A           N/A    
liblastlog2-2       2.41-5                                    deb     CVE-2026-53615       Unknown     N/A           N/A    
libmount1           2.41-5                                    deb     CVE-2026-53612       Unknown     N/A           N/A    
libmount1           2.41-5                                    deb     CVE-2026-53613       Unknown     N/A           N/A    
libmount1           2.41-5                                    deb     CVE-2026-53614       Unknown     N/A           N/A    
libmount1           2.41-5                                    deb     CVE-2026-53615       Unknown     N/A           N/A    
libsmartcols1       2.41-5                                    deb     CVE-2026-53612       Unknown     N/A           N/A    
libsmartcols1       2.41-5                                    deb     CVE-2026-53613       Unknown     N/A           N/A    
libsmartcols1       2.41-5                                    deb     CVE-2026-53614       Unknown     N/A           N/A    
libsmartcols1       2.41-5                                    deb     CVE-2026-53615       Unknown     N/A           N/A    
libuuid1            2.41-5                                    deb     CVE-2026-53612       Unknown     N/A           N/A    
libuuid1            2.41-5                                    deb     CVE-2026-53613       Unknown     N/A           N/A    
libuuid1            2.41-5                                    deb     CVE-2026-53614       Unknown     N/A           N/A    
libuuid1            2.41-5                                    deb     CVE-2026-53615       Unknown     N/A           N/A    
login               1:4.16.0-2+really2.41-5                   deb     CVE-2026-53612       Unknown     N/A           N/A    
login               1:4.16.0-2+really2.41-5                   deb     CVE-2026-53613       Unknown     N/A           N/A    
login               1:4.16.0-2+really2.41-5                   deb     CVE-2026-53614       Unknown     N/A           N/A    
login               1:4.16.0-2+really2.41-5                   deb     CVE-2026-53615       Unknown     N/A           N/A    
mount               2.41-5                                    deb     CVE-2026-53612       Unknown     N/A           N/A    
mount               2.41-5                                    deb     CVE-2026-53613       Unknown     N/A           N/A    
mount               2.41-5                                    deb     CVE-2026-53614       Unknown     N/A           N/A    
mount               2.41-5                                    deb     CVE-2026-53615       Unknown     N/A           N/A    
util-linux          2.41-5                                    deb     CVE-2026-53612       Unknown     N/A           N/A    
util-linux          2.41-5                                    deb     CVE-2026-53613       Unknown     N/A           N/A    
util-linux          2.41-5                                    deb     CVE-2026-53614       Unknown     N/A           N/A    
util-linux          2.41-5                                    deb     CVE-2026-53615       Unknown     N/A           N/A    
```
